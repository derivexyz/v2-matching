...
contract CCTSA_BaseTSA_WithdrawalTests is CCTSATestUtils {
  ...
  function testWithdrawals() public {
    ...
    cctsa.requestWithdrawal(100e18);
    cctsa.requestWithdrawal(200e18);
    cctsa.requestWithdrawal(300e18);

    // totalSupply includes pending withdrawals
    assertEq(cctsa.totalPendingWithdrawals(), 600e18);
    assertEq(cctsa.totalSupply(), 1000e18);
    assertEq(cctsa.balanceOf(address(this)), 400e18);
    assertEq(markets["weth"].erc20.balanceOf(address(this)), 0);

    cctsa.processWithdrawalRequests(1);
    assertEq(cctsa.totalPendingWithdrawals(), 500e18);
    assertEq(cctsa.totalSupply(), 900e18);
    assertEq(cctsa.balanceOf(address(this)), 400e18);
    assertEq(markets["weth"].erc20.balanceOf(address(this)), 100e18);

    cctsa.processWithdrawalRequests(1);
    assertEq(cctsa.totalPendingWithdrawals(), 300e18);
    assertEq(cctsa.totalSupply(), 700e18);
    assertEq(cctsa.balanceOf(address(this)), 400e18);
    assertEq(markets["weth"].erc20.balanceOf(address(this)), 300e18);

    cctsa.processWithdrawalRequests(1);
    assertEq(cctsa.totalPendingWithdrawals(), 0);
    assertEq(cctsa.totalSupply(), 400e18);
    assertEq(cctsa.balanceOf(address(this)), 400e18);
  ...
  function testWithdrawalReverts() public {
    ...
    // withdrawals are blocked when there is a liquidation
    uint w1 = cctsa.requestWithdrawal(100e18);
    uint w2 = cctsa.requestWithdrawal(200e18);
    uint w3 = cctsa.requestWithdrawal(300e18);
    ...
    // check state
    assertEq(cctsa.totalPendingWithdrawals(), 450e18);
    assertEq(cctsa.totalSupply(), 850e18);
    assertEq(cctsa.balanceOf(address(this)), 400e18);
    ...
    assertEq(cctsa.totalPendingWithdrawals(), 100e18);
    assertEq(cctsa.totalSupply(), 500e18);
    assertEq(cctsa.balanceOf(address(this)), 400e18);
