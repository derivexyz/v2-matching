...
contract RfqModuleTest is MatchingBase {
  ...
  function testDecodeData() public {
    // [
    //  (6,
    //  0x401D67e45e1d0517fE30628C7c860B236566ab7A,
    //  0x15a67BB8A5Be7A835c7FD71e85f68Ab2659aC045,
    //  ,
    //  1706656429298837,
    //  [
    //    1.706e15
    //  ]
    ...
    bytes memory takerData = hex"2ba76c7b23d4978c547c90bb5f27bcf6d8448160a408965be1c6246abf1aa2f8000000000000000000000000000000000000000000000000016345785d8a0000";
    IRfqModule.TakerOrder memory takerOrder = abi.decode(takerData, (IRfqModule.TakerOrder));
    console2.logBytes32(takerOrder.orderHash);

    bytes memory makerData = hex"";
    IRfqModule.RfqOrder memory rfqOrder = abi.decode(makerData, (IRfqModule.RfqOrder));
    console2.log("makerData", rfqOrder.trades.length);
  }
